...
//This code will set up and tear down the mock implementation so that each
// test starts from a level playing field.
beforeEach(() => {
...
test('should be able to search and display dog image result', async () => {
  render(<App />);
